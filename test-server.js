...
<head>
    ...
    <title>AISim Ad Creation Test</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="logo">🎯 AISim Ad Creation Test</div>
        <h2>Test Ad Generation System</h2>
        ...
        <form id="adForm">
            ...
            <button type="submit" class="btn">🤖 Generate AI Ad</button>
        </form>
    ...
    <script>
        document.getElementById('adForm').addEventListener('submit', async function(e) {
            ...
            // Show loading status
            statusDiv.innerHTML = '<div class="status">🔄 Generating AI ad... Please wait...</div>';
            resultDiv.innerHTML = '';
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    statusDiv.innerHTML = '<div class="status success">✅ Ad generated successfully via API!</div>';
                } else {
                ...
                statusDiv.innerHTML = '<div class="status error">⚠️ Using mock data (API not available)</div>';
            }
        });
        ...
        async function testBackend() {
            try {
                ...
                if (response.ok) {
                    ...
                    document.getElementById('status').innerHTML = '<div class="status success">✅ Backend API is accessible</div>';
                } else {
...
server.listen(PORT, () => {
    console.log(`🚀 AISim Ad Creation Test Server running on http://localhost:${PORT}`);
    console.log('✅ Test page ready for ad creation testing!');
    console.log('🎯 Open your browser to test ad generation');
